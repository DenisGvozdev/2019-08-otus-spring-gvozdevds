package ru.gds.spring.microservice.encode;
...
public class FeignSpringFormEncoder implements Encoder {
    ...
    private class HttpOutputMessageImpl implements HttpOutputMessage {
        ...
        HttpOutputMessageImpl(OutputStream body, HttpHeaders headers) {
            this.body = body;
    ...
    static class MultipartFileResource extends InputStreamResource {
        ...
        MultipartFileResource(String filename, long size, InputStream inputStream) {
            super(inputStream);
            this.size = size;
